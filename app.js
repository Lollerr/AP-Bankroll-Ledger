...
function showCalculatorsHome(){showPage('calculators');$('calculatorHub').hidden=false;$('calculatorPhoenix').hidden=true;$('calculatorWre').hidden=true;$('calculatorMtg').hidden=true;$('calculatorSup').hidden=true}
function openCalculator(name){showPage('calculators');$('calculatorHub').hidden=true;$('calculatorPhoenix').hidden=name!=='phoenix';$('calculatorWre').hidden=name!=='wre';$('calculatorMtg').hidden=name!=='mtg';$('calculatorSup').hidden=name!=='sup';if(name==='phoenix'){renderPhoenixCalculator();setTimeout(()=>{const el=$('phoenixCounter');if(el)el.focus()},0)}if(name==='wre'){renderWreCalculator();setTimeout(()=>{const el=$('wreMini');if(el)el.focus()},0)}if(name==='mtg'){renderMtgCalculator();setTimeout(()=>{const el=$('mtgGreen');if(el)el.focus()},0)}if(name==='sup'){renderSupCalculator();setTimeout(()=>{const el=$('supMega');if(el)el.focus()},0)}}
