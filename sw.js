const CACHE='ap-bankroll-v8-3-0';
...
self.addEventListener('fetch',e=>{
  ...
  // v8.3.0: API/cross-origin requests must always go to the network.
  ...
  const core=e.request.mode==='navigate'||/\/(?:index\.html|app\.js|styles\.css|config\.js|manifest\.webmanifest)$/.test(u.pathname);
  if(core){
    e.respondWith(
